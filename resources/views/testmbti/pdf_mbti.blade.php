...
<br><br><br><br>
     <table>
        ...
        <h4> ท่านได้คะแนน "I" กับ "E" อย่างไหนมากกว่ากันตอบ "{{$testmbti->answerIE}}" </h4>
                  หมายเหตุ:ถ้าได้คะแนน "I" เท่ากับ "E" จะไม่นับคะแนนข้อ 11
                 <h4>ท่านได้คะแนน "S" กับ "N" อย่างไหนมากกว่ากันตอบ  "{{$testmbti->answerSN}}" </h4>
        ...
        <table>
                ...
                <tbody>
                    ...
                    <h4>ท่านได้คะแนน "T" กับ "F" อย่างไหนมากกว่ากันตอบ "{{$testmbti->answerTF}}" </h4>

                   หมายเหตุ:ถ้าได้คะแนน "T" เท่ากับ "F" จะไม่นับคะแนนข้อ 11
            
                <h4>ท่านได้คะแนน "J" กับ "P" อย่างไหนมากกว่ากันตอบ  "{{$testmbti->answerJP}}" </h4>
                    ...
                    สรุปผลคือ <label>	{{$testmbti->conclude}} </label>  <br>
                        ...
                        {{$testmbti->meaning}}<br>
                                        ...
                                        สรุปผลการคิด คือ  <br>	{{$testmbti->meaningtwo}}   
