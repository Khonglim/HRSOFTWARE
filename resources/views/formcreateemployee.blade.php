                                    ...
                                    <td >
                                                   ...
                                                   <tr>
                                                        <td>อายุ:<input type="text"name="age" id="age" required="required"style="width:45px" />ปี&nbsp;&nbsp;&nbsp;
                                                          ...
                                                          พีน้อง:<input type="text" name="brothers" id="brothers" style="width:45px"/>&nbsp;คน
                                                          เป็นคนที่:<input type="text" name="number" id="number" style="width:45px" />
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td colspan="3">&nbsp;</td>
                                                        ...
                                                        <td>
                                                          สำนักงาน:<input type="text" name="office" id="office" style="width:100px"/>
                                                           ...
                                                           <tr>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>
                                                                  ชื่อคู่สมรส:
                                                                  <input type="text" name="name_spouse" id="name_spouse"  style="width:100px"/>
                                                                  อาชีพคู่สมรส:
                                                                  <input type="text" name="spouse_occupation" id="spouse_occupation" style="width:100px"/>
                                                                  สถานที่ทำงาน:
                                                                  <input type="text" name="firm_address" id="firm_address"  style="width:100px"/>
                                                                </td>
                                                                ...
                                                                <td>
                                                                  จำนวนบุตรทั้งหมด <input type="text" name="children" id="children"  style="width:50px"/> คน
                                                                  ชาย:<input type="text" name="boy" id="boy"  style="width:50px"/> คน
                                                                  หญิง:<input type="text" name="girls" id="girls"  style="width:50px"/>คน
                                                                  จำนวนบุตรกำลังศึกษา:<input type="text" name="school" id="school"  style="width:50px"/>คน
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td>
                                                                จำนวนบุตรที่อายุเกิน 21 ปี:<input type="text" name="over21" id="over21"  style="width:50px"/>คน
                                                                สถานะทางทหาร:
                                                                <select style="width:110px"name="military_service" >
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td>
                                                                      ชื่อบิดา:
                                                                      <input type="text" name="namefather" id="father" required="required" style="width:100px"/>
                                                                      นามสกุล:
                                                                      <input type="text" name="lastfather" id="lfather" required="required" style="width:100px"/>
                                                                     อาชีพ:
                                                                     <input type="text" name="occupation_father" id="occupation_father" required="required" style="width:100px"/>
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      ชื่อมารดา:
                                                                      <input type="text" name="namemother" id="mother" required="required" style="width:100px"/>
                                                                      นามสกุล:
                                                                      <input type="text" name="lasrmother" id="lmother" required="required" style="width:100px"/>
                                                                      อาชีพ:
                                                                      <input type="text" name="occupationm" id="occupationm" required="required" style="width:100px"/>
