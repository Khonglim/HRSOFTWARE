            ...
            <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#personal1" data-toggle="tab">1.ประวัติส่วนตัว</a></li>
                  <li><a href="#education2" data-toggle="tab">2.ประวัติการศึกษา</a></li>
                  <li><a href="#languages3" data-toggle="tab">3.ภาษา</a></li>
                  <li><a href="#employment4" data-toggle="tab">4.ประวัติการทำงาน</a></li>
                  <li><a href="#persons5" data-toggle="tab"> 5.อื่นๆ </a></li>
                </ul>
               
                <div class="tab-content">
                  <div class="tab-pane active" id="personal1">
                          <div class="row">      
                            <div class="col-md-2">
                                    <div class="form-group">
                ...
                <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                            <div class="form-group">
                                                    <label >จำนวนบุตรที่อายุเกิน 21 ปี</label>
                                        ...
                                        <div class="col-md-2">
                                                ...
                                                <select style="width:175px" name="military_service" class="form-control" >
                  ...
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="education2">
                  ...
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="languages3">
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-bordered">
                                <thead>
                                  <tr>
                  ...
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="employment4">
           <div class="box-body table-responsive no-padding">
                        <table class="table table-bordered">
                                <thead>
                                  <tr>
                  ...
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="persons5">
