    ...
    margin-left: 5px;
             ...
             @if(isset($employee))
                     <h3> แก้ไขข้อมูล
                       ...
                       เพิ่มข้อมูพนักงาน
                      @endif</h3> 
            <button class="accordion">ประวัติส่วนตัว</button>
            <div class="panel box box-primary">
              ...
              <table style="width:1300px" border="0"  cellpadding="0" cellspacing="0"  >
                 ...
                 <tr>
                    ...
                    <td colspan="3">&nbsp;</td>
                      ...
                      <td>
                        ...
                        ที่อยู่สามารถติดต่อได้:<input type="text" name="address1" id="address1" required="required" style="width:175px" />
                      </td>     
                 ...
                 <tr>
                  ...
                  <td>
                     ที่อยู่ตามบัตรประชาชน:<input type="text" name="address2" id="address2" required="required"style="width:200px"/>
            ...
            <br><br>
            <button class="accordion">ประวัติการศึกษา</button>
            <div class="panel box box-primary">
                    ...
                    <table style="width:1300px" border="0"  cellpadding="0" cellspacing="0"  >
                        <tr>
                          ...
                          <td>
                           ...
                           สาขา:
                           <input type="text" id="major" name="major" required="required" style="width:120px"/>
                          </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td>
                         มัธยมศึกษา:
                           <input type="text" id="secondary" name="secondary" required="required" style="width:100px"/>
                           ปีการศึกษา:
                           ...
                           สาขา:
                           <input type="text" id="majors" name="majors" required="required" style="width:147px"/>
                          </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td>
                        อาชีวะศึกษา:
                           <input type="text" id="vocation" name="vocation" required="required" style="width:100px"/>
                           ปีการศึกษา:
                           ...
                           สาขา:
                           <input type="text" id="majorv" name="majorv" required="required" style="width:140px"/>
                          </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td>
                         อนุปริญญา:
                           <input type="text" id="diploma" name="diploma" required="required" style="width:100px"/>
                           ปีการศึกษา:
                    ...
                    <tr>
                      ...
                      <tr>
                          <td>
                         ปริญญาตรี:
                           <input type="text" id="bachelor" name="bachelor" required="required" style="width:100px"/>
                           ปีการศึกษา:
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td>
                         ปริญญาโท:
                           <input type="text" id="master" name="master" required="required" style="width:100px"/>
                           ปีการศึกษา:
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; อื่นๆ:
                           <input type="text" id="otherE" name="other" required="required" style="width:100px"/>
                           ปีการศึกษา:
            ...
            <br><br>
            <button class="accordion">ภาษา</button>
            <div class="panel box box-primary">
              <br>
              <table style="width:1300px" border="0"  cellpadding="0" cellspacing="0"  >
                <tr>
            ...
            <br><br>
            <button class="accordion">ประวัติการทำงาน</button>
            <div class="panel box box-primary">
              <br>
                <table style="width:1300px" border="0"  cellpadding="0" cellspacing="0"  >    
...
<br><br>
            <button class="accordion">บุคคลที่ไม่ใช่ญาติซึ่งทราบประวัติของท่านและบริษัทฯ สามารถสอบถามได้</button>
            <div class="panel box box-primary">
                <br><br>
                    <table style="width:1300px" border="0"  cellpadding="0" cellspacing="0"  >   
                <tr>
                ...
                <tr>
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" class="form-check-input" id="do">เครื่องพิมพ์ดีดไทย<input  type="text" name="dot" id="dot" required="required" style="width=50px"/>คำ/นาที
                        ...
                        <tr>
                                <td>
                                        ในตำแหน่งที่ต้องการต้งมีผู้ค้ำประกัน(เป็นราชการ/รัฐวิสาหกิจ): 
                        ...
                        <tr>
                                <td>
                                    ในการปฏิบัติงานหมุนเวียนเป็นกะหมุนเวียนกันไป
                        ...
                        <tr>
                            <td>
                                 ท่านสามารถเปลี่ยนแปลงหน้าที่ตามความเหมาะสม
                                    <input type="checkbox" class="form-check-input" id="pop"> ขัดข้อง
                                    <input type="checkbox" class="form-check-input" id="pop"> ไม่ขัดข้อง        
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                    ท่านเคยให้ถูกออกจากงานหรือไม่: <input type="checkbox" class="form-check-input" id="exitwork">เคย
                           ...
                           <tr>
                            ...
                            <tr>
                                <td>
                                    ท่านเคยป่วยหนักและเป็นโรคร้ายแรงมาก่อนหรือไม่?<input type="checkbox" class="form-check-input" id="ill">เคย
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                                ท่านเคยไดรั้บโทษทางอาญาหรือจำคุก หรือ เป็นบุคคลล้มละลาย หรือไม่?<input type="checkbox" class="form-check-input" id="offense">เคย
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                    <td>
                                                           ขณะนี้คุณตั้งครรภ์หรือไม่?<input type="checkbox" class="form-check-input" id="pregnant">ใช่
