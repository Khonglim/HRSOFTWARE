      ...
      <div class="col-xs-12,col-md-6,col-ms-3" >
        <div class="box"  style="background-color: #edf9ff;">
          ...
          <div class="box-body">
            ...
            $data2change = array();$data3change = array();$data4change = array();$data5change = array(); $comment1 = array();$comment2 = array();$comment3 = array();$comment4 = array();$comment5 = array(); $commentcount=0; $commenttemp='';  $sick_leave =0;$personal_leave = 0;$late = 0; $miss_work = 0; $annual_leave = 0;$totle_atten = 0;?>
                          ...
                          <div id="swapname"><a href="{{'reportv2_officer'}}" class="btn btn-primary btn-lg" ><i class="fa fa-eye fa-6" aria-hidden="true"></i></a></div>
                           ...
                           <div id="report" style="display: none;"> <a href="{{'print_blind_report_officer'}}" class="btn btn-primary btn-lg" ><i class="fa fa-print fa-6" aria-hidden="true"></i></a></div>
