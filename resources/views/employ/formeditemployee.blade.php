                                ...
                                <div class="box box-danger">
                                        ...
                                        <div class="box-body">
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-2 ">
                                                                <div class="form-group label-floating">
                                                                        <label class="control-label">เงินเดือนที่ต้องการ<small class="text-danger">*</small></label>                                                                        {{ Form::text('salaryngg',$personal->salaryngg, ['class'
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group label-floating">
                                                                        <label class="control-label">ตำแหน่งที่จะสมัคร<small class="text-danger">*</small></label>                                                                        {{ Form::text('positionngg',$personal->positionngg,
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                                                        <label>รูปภาพ || {{$personal->photo}}||</label> {{Form::file('image')}}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-1 ">
                                                                <div class="input-group">
                                                                        <div class="form-group label-floating">
                                                                                <label class="control-label">คำนำ<small class="text-danger">*</small></label>                                                                                {{ Form::select('fronname', [ $personal->fronname
                                                                                =>$personal->fronname, 'นาย' => 'นาย','นาง'
                                                                                => 'นาง','นางสาว'=> 'นางสาว'],null, ['class'
                                                                                => 'form-control','required']) }}
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                                                        <label for="name">ชื่อ</label> {{Form::text('name',$personal->name,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                                                        <label>นามสกุล</label> {{Form::text('lastname',$personal->lastname,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('nikname') ? 'has-error' : '' }}">
                                                                        <label>ชื่อล่น</label> {{Form::text('nikname',$personal->nikname,['class'=>'form-control'])}}
                                                                        <span class="text-danger">{{ $errors->first('nikname') }}</span>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                                                                        <label>เพศ</label><br> @if($personal->gender == 'ชาย')
                                                                        ชาย {{ Form::radio('gender', 'ชาย',true) }} หญิง
                                                                        {{ Form::radio('gender', 'หญิง') }} @else ชาย {{
                                                                        Form::radio('gender', 'ชาย') }} หญิง {{ Form::radio('gender',
                                                                        'หญิง',true) }} @endif
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('birthday') ? 'has-error' : '' }}">
                                                                        <label>วันเกิด</label> {{Form::date('birthday',$personal->birthday,['class'=>'form-control'])}}
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('nationality') ? 'has-error' : '' }}">
                                                                        <label>สัญชาติ</label> {{ Form::select('nationality',
                                                                        [ $personal->nationality => $personal->nationality,
                                                                        'ไทย' => 'ไทย', 'คริสต์' => 'คริสต์', 'อิสลาม' =>
                                                                        'อิสลาม', 'อื่นๆ'=> 'อื่นๆ' ],null, ['class' => 'form-control'])
                                                                        }}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('race') ? 'has-error' : '' }}">
                                                                        <label>เชื้อชาติ</label> {{ Form::select('race',
                                                                        [ $personal->race => $personal->race, 'ไทย' => 'ไทย',
                                                                        'คริสต์' => 'คริสต์', 'อิสลาม' => 'อิสลาม', 'อื่นๆ'=>
                                                                        'อื่นๆ' ],null, ['class' => 'form-control']) }}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('religion') ? 'has-error' : '' }}">
                                                                        <label>ศาสนา</label> {{ Form::select('religion',
                                                                        [ $personal->religion => $personal->religion, 'พุทธ'
                                                                        => 'พุทธ', 'คริสต์' => 'คริสต์', 'อิสลาม' => 'อิสลาม',
                                                                        'อื่นๆ'=> 'อื่นๆ' ],null, ['class' => 'form-control'])
                                                                        }}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('age') ? 'has-error' : '' }}">
                                                                        <label>อายุ</label> {{Form::text('age',$personal->age,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('height') ? 'has-error' : '' }}">
                                                                        <label>ส่วนสูง</label> {{Form::text('height',$personal->height,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('weight') ? 'has-error' : '' }}">
                                                                        <label>น้ำหนัก</label> {{Form::text('weight',$personal->weight,['class'=>'form-control'])}}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>พี่น้องกี่คน</label> {{Form::text('brothers',$personal->brothers,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>เป็นคนที่</label> {{Form::text('number',$personal->number,['class'=>'form-control'])}}

                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group  {{ $errors->has('tel') ? 'has-error' : '' }}">
                                                                        <label>โทรศัพท์ที่ติดต่อ</label> {{Form::text('tel',$personal->tel,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>โทรศัพท์บ้าน</label> {{Form::text('home',$personal->home,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('moblie') ? 'has-error' : '' }}">
                                                                        <label>โทรศัพท์มือถือ</label> {{Form::text('moblie',$personal->moblie,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>โทรศัพท์สำนักงาน</label> {{Form::text('office',$personal->office,['class'=>'form-control'])}}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                                                        <label>อีเมล</label> {{Form::email('email',$personal->email,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('idcard') ? 'has-error' : '' }}">
                                                                        <label>เลขบัตรประชาชน</label> {{Form::text('idcard',$personal->idcard,['class'=>'form-control'])}}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('province_crad') ? 'has-error' : '' }}">
                                                                        <label>จังหวัด</label> {{ Form::text('province_crad',$personal->province_crad,
                                                                        ['class' => 'form-control']) }}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group  {{ $errors->has('issued') ? 'has-error' : '' }}">
                                                                        <label>ออกให้ ณ อำเภอ/เขต:</label> {{Form::text('issued',$personal->issued,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('issueddate') ? 'has-error' : '' }}">
                                                                        <label>วันออกบัตร</label> {{Form::date('issueddate',$personal->issueddate,['class'=>'form-control'])}}
                                                                        <span class="text-danger">{{ $errors->first('issueddate') }}</span>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('expid') ? 'has-error' : '' }}">
                                                                        <label>บัตรหมดอายุ:</label> {{Form::date('expid',$personal->expid,['class'=>'form-control'])}}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-3">
                                                                <div class="form-group">
                                                                        <label>บัตรประจำตัวผู้เสียภาษี</label> {{Form::date('texid',$personal->texid,['class'=>'form-control'])}}

                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('living_status') ? 'has-error' : '' }}">
                                                                        <label>สถานะความเป็นอยู่</label> {{ Form::select('living_status',
                                                                        [ $personal->living_status=>$personal->living_status,
                                                                        'บ้านส่วนตัว' => 'บ้านส่วนตัว', 'บ้านเช่า' => 'บ้านเช่า',
                                                                        'อาศัยกับบิดามารดา'=> 'อาศัยกับบิดามารดา', 'อาศัยกับผู้อื่น'=>'อาศัยกับผู้อื่น'
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group{{ $errors->has('marital_status') ? 'has-error' : '' }}">
                                                                        <label>สถานะครอบครัว</label> {{ Form::select('marital_status',
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>กรณีแต่งงาน</label> {{ Form::select('if_marricd',
                                                                        [ $personal->if_marricd=>$personal->if_marricd, 'จดทะเบียนสมรส'
                                                                        => 'จดทะเบียนสมรส', 'ไม่ได้จดทะเบียนสมรส' => 'ไม่ได้จดทะเบียนสมรส'
                                                                        ],null, ['class' => 'form-control']) }}
                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>คู่มสมรส</label> {{ Form::select('spouse',
                                                                        [ $personal->spouse=>$personal->spouse, 'มี' => 'มี',
                                                                        'ไม่มี' => 'ไม่มี' ],null, ['class' => 'form-control'])
                                                                        }}
                                                ...
                                                <div class="row">
                                                        <div class="col-md-4">
                                                                <div class="form-group">
                                                                        <label>ชื่อคู่สมรส</label> {{Form::text('name_spouse',$personal->name_spouse,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                                <div class="form-group">
                                                                        <label>อาชีพคู่สมรส</label> {{Form::text('spouse_occupation',$personal->spouse_occupation,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>

                                                        <div class="col-md-3">
                                                                <div class="form-group">
                                                                        <label> สถานที่ทำงาน</label> {{Form::text('firm_address',$personal->firm_address,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>โทรศัพท์</label> {{Form::text('spouse_tel',$personal->spouse_tel,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>จำนวนบุตรทั้งหมด</label> {{Form::text('children',$personal->children,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>หญิง</label> {{Form::text('girls',$personal->girls,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>ชาย</label> {{Form::text('boy',$personal->boy,['class'=>'form-control'])}}
                                                                </div>
                                                        </div>

                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label> จำนวนบุตรกำลังศึกษา</label> {{Form::text('school',$personal->school,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-2">
                                                                <div class="form-group">
                                                                        <label>จำนวนบุตรที่อายุเกิน21ปี</label> {{Form::text('over21',$personal->over21,['class'=>'form-control'])}}

                                                                </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                                <div class="form-group {{ $errors->has('military_service') ? 'has-error' : '' }}">
                                                                        <label> สถานะทางทหาร</label> {{ Form::select('military_service',
                                                                        [ $personal->military_service=>$personal->military_service,
                                                                        'ได้รับการยกเว้น' => 'ได้รับการยกเว้น', 'ศึกษาวิชาทหาร'
                                                                        => 'ศึกษาวิชาทหาร', 'ผ่านการเกณฑ์ทหาร' => 'ผ่านการเกณฑ์ทหาร'
                                                                        ],null, ['class' => 'form-control']) }}
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group  {{ $errors->has('namefather') ? 'has-error' : '' }}">
                                                                        <label> ชื่อบิดา</label> {{Form::text('namefather',$personal->namefather,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('lastfather') ? 'has-error' : '' }}">
                                                                        <label>นามสกุล</label> {{Form::text('lastfather',$personal->lastfather,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('occupation_father') ? 'has-error' : '' }}">
                                                                        <label>อาชีพ</label> {{Form::text('occupation_father',$personal->occupation_father,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3"><br>
                                                                <div class="form-group{{ $errors->has('alivef') ? 'has-error' : '' }}">
                                                                        @if($personal->alivef == 'ยังมีชีวิตอยู่') {{ Form::radio('alivef', 'ยังมีชีวิตอยู่',true) }}ยังมีชีวิตอยู่ {{ Form::radio('alivef',
                                                                        'ถึงแก่กรรม') }}ถึงแก่กรรม @else {{ Form::radio('alivef',
                                                                        'ยังมีชีวิตอยู่') }}ยังมีชีวิตอยู่ {{ Form::radio('alivef',
                                                                        'ถึงแก่กรรม',true) }}ถึงแก่กรรม @endif
                                                ...
                                                <div class="row">
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('namemother') ? 'has-error' : '' }}">
                                                                        <label> ชื่อมารดา</label> {{Form::text('namemother',
                                                                        $personal->namemother,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('lasrmother') ? 'has-error' : '' }}">
                                                                        <label>นามสกุล</label> {{Form::text('lasrmother',$personal->lasrmother,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('occupationm') ? 'has-error' : '' }}">
                                                                        <label>อาชีพ</label> {{Form::text('occupationm',$personal->occupationm,['class'=>'form-control'])}}
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group {{ $errors->has('alivem') ? 'has-error' : '' }}">
                                                                        @if($personal->alivem == 'ยังมีชีวิตอยู่') {{ Form::radio('alivem', 'ยังมีชีวิตอยู่',true) }}ยังมีชีวิตอยู่ {{ Form::radio('alivem',
                                                                        'ถึงแก่กรรม') }}ถึงแก่กรรม @else {{ Form::radio('alivem',
                                                                        'ยังมีชีวิตอยู่') }}ยังมีชีวิตอยู่ {{ Form::radio('alivem',
                                                                        'ถึงแก่กรรม',true) }}ถึงแก่กรรม @endif
                                                ...
                                                <div class="box-body table-responsive no-padding">
                                                        <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <tr>
                                                                                <td>มัธยมศึกษา</td>
                                                                                <td>{{Form::text('secondary',$personal->secondary,['class'=>'form-control'])}}
                                                                                        </td>
                                                                                <td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td>{{Form::text('gpav',$personal->gpav,['class'=>'form-control'])}}
                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td>{{Form::text('majord',$personal->majord,['class'=>'form-control'])}}
                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td> {{Form::text('year10',$personal->year10,['class'=>'form-control'])}}
                                                                                        </td>
                                                                                <td>{{Form::text('gpab',$personal->gpab,['class'=>'form-control'])}}
                                                                                        </td>
                                                                                <td>{{Form::text('majorb',$personal->majorb,['class'=>'form-control'])}}
                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td>{{Form::text('gpam',$personal->gpam,['class'=>'form-control'])}}
                                                                                        </td>
                                ...
                                <div class="box box-danger">
                                        ...
                                        <div class="box-body">
                                                <div class="box-body table-responsive no-padding">
                                                        <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                        <tr>
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('thais') ? 'has-error' : '' }}">
                                                                                                ...
                                                                                                {{ Form::select('thais', [ $personal->thais=>$personal->thais, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                                ['class' => 'form-control'])
                                                                                                }}
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('thail') ? 'has-error' : '' }}">
                                                                                                {{ Form::select('thail', [ $personal->thail=>$personal->thail, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                                ['class' => 'form-control'])
                                                                                                }}
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('thair') ? 'has-error' : '' }}">
                                                                                                ...
                                                                                                {{ Form::select('thair', [ $personal->thair=>$personal->thair, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                                ['class' => 'form-control'])
                                                                                                }}
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('engliss') ? 'has-error' : '' }}">
                                                                                                ...
                                                                                                {{ Form::select('engliss', [ $personal->engliss=>$personal->engliss, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี'
                                                                                                ],null, ['class' => 'form-control'])
                                                                                                }}
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('englisl') ? 'has-error' : '' }}">
                                                                                                {{ Form::select('englisl', [ $personal->englisl=>$personal->englisl, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี'
                                                                                                ],null, ['class' => 'form-control'])
                                                                                                }}
                                                                                ...
                                                                                <td>
                                                                                        <div class="form-group {{ $errors->has('englisr') ? 'has-error' : '' }}">
                                                                                                {{ Form::select('englisr', [ $personal->englisr=>$personal->englisr, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี'
                                                                                                ],null, ['class' => 'form-control'])
                                                                                                }}
                                                                        ...
                                                                        <tr>
                                                                                <td>อื่นๆ{{Form::text('otherr',$personal->otherr,['class'=>'form-control'])}}
                                                                                        </td>
                                                                                <td>
                                                                                        {{ Form::select('othes', [ $personal->othes=>$personal->othes, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                        ['class' => 'form-control']) }}
                                                                                </td>
                                                                                <td>
                                                                                        {{ Form::select('othel', [ $personal->othel=>$personal->othel, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                        ['class' => 'form-control']) }}

                                                                                </td>
                                                                                <td>
                                                                                        {{ Form::select('other', [ $personal->other=>$personal->other, 'ดี' => 'ดี', 'พอใช้' => 'พอใช้', 'ไม่ดี' => 'ไม่ดี' ],null,
                                                                                        ['class' => 'form-control']) }}
                                                                                </td>
                                                                        </tr>
                                                                </tbody>
                                                                                        ...
                                                                                        <table class="table table-bordered">
                                                                                                ...
                                                                                                <tbody>
                                                                                                        <tr>
                                                                                                                ...
                                                                                                                <td> {{Form::text('lastsalary1',$personal->lastsalary1,['class'=>'form-control'])}}
                                                                                                                        </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                ...
                                                                                                                <td> {{Form::text('lastsalary3',$personal->lastsalary3,['class'=>'form-control'])}}
                                                                                                                        </td>
                                                                                                        </tr>
                                                                                                </tbody>
                                                                                        </table>
                                                                        ...
                                                                        <div class="box-body">
                                                                                ...
                                                                                <div class="box-body table-responsive no-padding">
                                                                                        ...
                                                                                        <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-5">
                                                                                                        <div class="form-group">
                                                                                                                <label>Link ผลงาน </label>                                                                                                                {{Form::text('portfolio1',$personal->portfolio1,['class'=>'form-control'])}}
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-5">
                                                                                                        <div class="form-group">
                                                                                                                <label for="name">ความรู้พิเศษ</label>                                                                                                                คอมพิวเตอร์
                                                                                                                ระบุ: {{Form::text('computer',$personal->computer)}}
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-12">
                                                                                                        <div class="form-group {{ $errors->has('crash1') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->crash1
                                                                                                                == 'ขัดข้อง')
                                                                                                                {{ Form::radio('crash1','ขัดข้อง',true)
                                                                                                                }} ขัดข้อง
                                                                                                                {{ Form::radio('crash1','ไม่ขัดข้อง')
                                                                                                                }} ไม่ขัดข้อง
                                                                                                                ชื่อ: {{Form::text('compd',$personal->compd)}}
                                                                                                                สถานที่ทำงาน:
                                                                                                                {{Form::text('compa',$personal->compa)}}
                                                                                                                @else {{
                                                                                                                Form::radio('crash1','ขัดข้อง')
                                                                                                                }} ขัดข้อง
                                                                                                                {{ Form::radio('crash1','ไม่ขัดข้อง',true)
                                                                                                                }} ไม่ขัดข้อง
                                                                                                                ชื่อ: {{Form::text('compd',$personal->compd)}}
                                                                                                                สถานที่ทำงาน:
                                                                                                                {{Form::text('compa',$personal->compa)}}
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-10">
                                                                                                        <div class="form-group {{ $errors->has('crash2') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->crash2
                                                                                                                == 'ขัดข้อง')
                                                                                                                {{ Form::radio('crash2','ขัดข้อง',true)
                                                                                                                }}ขัดข้อง
                                                                                                                {{ Form::radio('crash2','ไม่ขัดข้อง')
                                                                                                                }}ไม่ขัดข้อง
                                                                                                                @else {{
                                                                                                                Form::radio('crash2','ขัดข้อง')
                                                                                                                }}ขัดข้อง
                                                                                                                {{ Form::radio('crash2','ไม่ขัดข้อง',true)
                                                                                                                }}ไม่ขัดข้อง
                                                                                                                @endif
                                                                                                                <br>
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                        <div class="form-group {{ $errors->has('crash3') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->crash3
                                                                                                                == 'ขัดข้อง')
                                                                                                                {{ Form::radio('crash3','ขัดข้อง',true)
                                                                                                                }} ขัดข้อง
                                                                                                                {{ Form::radio('crash3','ไม่ขัดข้อง')
                                                                                                                }}ไม่ขัดข้อง
                                                                                                                @else {{
                                                                                                                Form::radio('crash3','ขัดข้อง')
                                                                                                                }} ขัดข้อง
                                                                                                                {{ Form::radio('crash3','ไม่ขัดข้อง',true)
                                                                                                                }}ไม่ขัดข้อง
                                                                                                                <br>
                                                                                                                <span class="text-danger">{{ $errors->first('crash3') }}</span>                                                                                                                @endif
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                        <div class="form-group {{ $errors->has('owncar') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->owncar
                                                                                                                == 'มี')
                                                                                                                {{ Form::radio('owncar','มี',true)
                                                                                                                }} มี {{
                                                                                                                Form::radio('owncar','ไม่มี')
                                                                                                                }}ไม่มี @else
                                                                                                                {{ Form::radio('owncar','มี')
                                                                                                                }} มี {{
                                                                                                                Form::radio('owncar','ไม่มี',true)
                                                                                                                }}ไม่มี @endif
                                                                                                                <br>
                                            ...
                                            <div class="row">      
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-10">
                                                                                                        <div class="form-group {{ $errors->has('exitwork') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->exitwork
                                                                                                                == 'เคย')
                                                                                                                {{ Form::radio('exitwork','เคย',true)
                                                                                                                }} เคย เพราะ{{Form::text('because',$personal->because)}}
                                                                                                                &emsp;&emsp;&emsp;
                                                                                                                {{ Form::radio('exitwork','ไม่เคย')
                                                                                                                }}ไม่เคย
                                                                                                                @else {{
                                                                                                                Form::radio('exitwork','เคย')
                                                                                                                }} เคย เพราะ{{Form::text('because',$personal->because)}}
                                                                                                                &emsp;&emsp;&emsp;
                                                                                                                {{ Form::radio('exitwork','ไม่เคย',true)
                                                                                                                }}ไม่เคย
                                                                                                                @endif
                                                                                                                <br>
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                        <div class="form-group {{ $errors->has('serious_ill') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->serious_ill
                                                                                                                == 'เคย')
                                                                                                                {{ Form::radio('serious_ill','เคย',true)
                                                                                                                }}เคย {{
                                                                                                                Form::radio('serious_ill','ไม่เคย')
                                                                                                                }}ไม่เคย<br>                                                                                                                @else {{
                                                                                                                Form::radio('serious_ill','เคย')
                                                                                                                }}เคย {{
                                                                                                                Form::radio('serious_ill','ไม่เคย',true)
                                                                                                                }}ไม่เคย<br>                                                                                                                @endif
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-12">
                                                                                                        <div class="form-group  {{ $errors->has('offense') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->offense
                                                                                                                == 'เคย')
                                                                                                                {{ Form::radio('offense','เคย',true)
                                                                                                                }}เคย {{
                                                                                                                Form::radio('offense','ไม่เคย')
                                                                                                                }}ไม่เคย
                                                                                                                @else {{
                                                                                                                Form::radio('offense','เคย')
                                                                                                                }}เคย {{
                                                                                                                Form::radio('offense','ไม่เคย',true)
                                                                                                                }}ไม่เคย
                                                                                                                @endif
                                                                                                                <br>
                                                                                        ...
                                                                                        <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                        <div class="form-group {{ $errors->has('pregnant') ? 'has-error' : '' }}">
                                                                                                                ...
                                                                                                                @if($personal->pregnant
                                                                                                                == 'ใช่')
                                                                                                                {{ Form::radio('pregnant','ใช่',true)
                                                                                                                }}ใช่ {{
                                                                                                                Form::radio('pregnant','ไม่ใช่')
                                                                                                                }} ไม่ใช่
                                                                                                                @else {{
                                                                                                                Form::radio('pregnant','ใช่')
                                                                                                                }}ใช่ {{
                                                                                                                Form::radio('pregnant','ไม่ใช่',true)
                                                                                                                }} ไม่ใช่
                                                                                                                @endif
                                                                                                                <br>
                                                ...
                                                {{ Form::submit('บันทึก',['class'=> 'btn btn-success'])}} {{ Form::close()}}
