            ...
            <div class="content container-fluid">
                    ...
                    <div class="box box-info">
                              ...
                              <div class="box-body">
                                    ...
                                    <div class="form-group">
                                            <label  class="col-sm-2 control-label">ชื่อ-สกุล:</label>
                                                ...
                                                <input   type="hidden"  value="{{$employees->id}}" name="idemploy"  >
                                                    ...
                                                    <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="id_employ" value="{{$operate_sup->id_employ}}" readonly >
                                                          </div>
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="position"   value="{{$operate_sup->position}}"   readonly>
                                                              </div> 
                                                              
                                                              <label  class="col-sm-2 control-label">แผนก/ฝ่าย:</label>
                                                              <div class="col-sm-4">
                                                              <input type="text" class="form-control" name="department"  value="{{$operate_sup->department}}" readonly>
                                                                    </div>     
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                        <input type="text" name="dateStart2" value="{{$operate_sup->starttime}}" class="form-control" readonly /> 
                                                              </div> 
                                                              
                                                              <label  class="col-sm-2 control-label">ครบการทดลองงาน:</label>
                                                              <div class="col-sm-4">
                                                                    <input type="text" name="dateEnd2"  value="{{$operate_sup->endtime}}" class="form-control"  readonly  /> 
                                                                    </div>     
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                                <input type="text" name="totolDay2"  value="{{$operate_sup->number}}"  readonly class="form-control" required/>
                                                              </div> 
                                                              
                                                              <label  class="col-sm-2 control-label">ระดับ:</label>
                                                              <div class="col-sm-4">
                                                              <input type="text" name="degree" value="{{$operate_sup->degree}}"   class="form-control" readonly/> 
                                                                    </div>     
                                                  </div>
                                ...
                                …….	ต้องปรับปรุง	=     	ผลการปฏิบัติงานต่ำกว่าเกณฑ์มาตรฐานที่กำหนดไว้มาก ยังต้องมีการปรับปรุงอีกมาก<br>
                                  ...
                                  <table id="customers">
                                        ...
                                        <tr>
                                          <td style="text-align:center">ตั้งแต่วันที่  <input type="text" name="startrate_60" value="{{$operate_sup->startwork_60}}"  readonly > <br><br>
                                            ถึงวันที่    <input type="text" name="endrate_60"  value="{{$operate_sup->endwork_60}}" readonly >
                                        
                                        
                                        </td>
                                          <td style="text-align:center"> <input type="text" name="sick"     value="{{$operate_sup->sick_leave_60}}"   style="width:50px" readonly> </td>
                                          <td style="text-align:center"><input type="text" name="errand"      value="{{$operate_sup->errand_leave_60}}"   style="width:50px" readonly ></td>
                                          <td style="text-align:center"><input type="text" name="absence"    value="{{$operate_sup->absence_60}}"  style="width:50px" readonly></td>
                                          <td style="text-align:center"><input type="text"   name="vacation"  value="{{$operate_sup->vacation_60}}"   style="width:50px"  readonly></td>
                                          <td style="text-align:center"><input type="text"  name="line"   value="{{$operate_sup->line_terms_60}}"    style="width:50px"  readonly></td>
                            ...
                            <table id="customers">
                              ...
                              @foreach ($operate_qSup as $operate_qSef)
                                     
                             
                               <tr>
                            
                            
                                    <td  style="width:43%"  > {{  $operate_qSef->operate_qsup  }} </td>
                                    <td style="text-align:center">
                                                @foreach ($operate_Chioce as $item)
                                                    
                                                 
                                                <input type="radio" id="score90_{{$operate_qSef->id}}" name="score90_{{$operate_qSef->id}}" value={{$item->score_operate}} required > {{$item->score_operate}}&ensp;
                               ...
                               <tr>
                                 ...
                                 <tr>
                                    <td  COLSPAN="2" >
                                        ...
                                        รวมคะแนนทั้งสิ้น <br><br> ประเมินครั้งที่ 1 : 60 วัน   <input type="text" name="rate_60" id="rate_60" value="{{$operate_sup->rate_60}}" readonly style="text-align:center"  > คะแนน  <br><br>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                  <textarea class="form-control" rows="3" name="assessor" readonly>{{$operate_sup->comments_60}}</textarea>
                                        </div> 
