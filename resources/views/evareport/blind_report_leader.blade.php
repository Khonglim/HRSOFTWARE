     ...
     <div class="row">
       <div class="col-md-4">
         <div class="form-group">
           <label for="identity" class="col-md-4 control-label">ชื่อ-นามสกุล:</label> 
...
<div class="container">
  <div class="row">
  <div class="col-md-7">
    <div id="columnchart_material_p1_1" class="chart" style="width: 550px; height: 400px;" ></div>
  </div>
  <div class="col-md-4">
    <div id="columnchart_material_p2_2" class="chart" style="width: 550px; height: 400px;" ></div>
  </div> 
  </div>
</div>
<br><br>
<div class="container">
  <div class="row">
  <div class="col-md-7">
    <div id="columnchart_material_p3_3" class="chart" style="width: 550px; height: 400px;" ></div>
  </div>
  <div class="col-md-4">
    <div id="columnchart_materialp4_4" class="chart" style="width: 550px; height: 400px;" ></div>
  </div> 
  </div>
</div>
...
<div class="container">
  <div class="row">
  <div class="col-md-7">
    <div id="columnchart_material_p5_5" class="chart" style="width: 550px; height: 400px;" ></div>
  </div>
  <div class="col-md-4">
